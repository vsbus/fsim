...
{
    public class fsContinuousNonModularBeltFilterCalculator : fsCalculator
    {
        public fsContinuousNonModularBeltFilterCalculator()
        {
            ...
            Equations.Add(new fsProductEquation(lOverB, constantOne, lsOverB));
            Equations.Add(new fsProductEquation(nsf, constantOne, sf));
            ...
            Equations.Add(new fsProductEquation(filterLength, constantOne, ls));
            ...
            Equations.Add(new fsSumEquation(constantOne, nsf, nsr));
            Equations.Add(new fsSumEquation(tc, tr, filtrationTime));
            Equations.Add(new fsSumEquation(constantOne, sr, sf));
            Equations.Add(new fsTrSrTtechNsTcEquation(sr, tr, tc, constantOne, constantZero));
            Equations.Add(new fsTfSfTtechNsTcEquation(sf, filtrationTime, tc, constantOne, constantZero));
            ...
            Equations.Add(new fsHcQmsEquation(cakeHeigth, Qms, filterArea, rhoCd, hce0, constantOne, constantZero, kappa, pc, pressureDifference, sf, etaf));
