...
namespace Units
{
    public struct fsUnit
    {
        ...
        public static fsUnit LiterPerSquaredMeterPerSec = new fsUnit("l/(m2 s)", 1.0);
        public static fsUnit LiterPerSquaredMeterPerMin = new fsUnit("l/(m2 min)", 1.0 / 60);
        public static fsUnit LiterPerSquaredMeterPerHour = new fsUnit("l/(m2 h)", 1.0 / 3600);
