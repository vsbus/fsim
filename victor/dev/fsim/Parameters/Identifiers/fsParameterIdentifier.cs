...
namespace Parameters
{
    public class fsParameterIdentifier
    {
        ...
        public static fsParameterIdentifier qmft =
            new fsParameterIdentifier("qmft", "Spec filtrate mass rate rel to t", fsCharacteristic.SpecificMassFlowrate);

        public static fsParameterIdentifier ViscosityFiltrate
            = new fsParameterIdentifier("etaf", "Viscosity Filtrate", fsCharacteristic.Viscosity);
