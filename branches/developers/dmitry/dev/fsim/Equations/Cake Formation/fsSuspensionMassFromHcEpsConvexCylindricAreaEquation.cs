...
namespace Equations
{
    public class fsSuspensionMassFromHcEpsConvexCylindricAreaEquation : fsCalculatorEquation
    {
        #region Parameters
        ...
        public fsSuspensionMassFromHcEpsConvexCylindricAreaEquation(
        ...
        private void FilterDiameterFormula()
        {
            ...
            m_filterDiameter.Value = m_cakeHeight.Value / (left / right - 1);
        }
