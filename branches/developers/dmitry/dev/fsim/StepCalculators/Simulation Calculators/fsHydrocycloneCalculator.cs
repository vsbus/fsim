...
namespace StepCalculators.Simulation_Calculators
{
    public class fsHydrocycloneCalculator : fsCalculator
    {
        ...
        {  
            ...
            Equations.Add(new fsXRed50XuiDuOverDDpEquation(DuOverD, Dp, xRed50, alpha1, alpha2, alpha3, beta1, beta2, beta3, gamma1, gamma2, gamma3, cv, rhoF, rhoS, etaf, sigmaS, sigmaG, xG, xui, i));
