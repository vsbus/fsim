...
namespace Units
{
    public struct fsUnit
    {
        ...
        public static fsUnit CentiMeter = new fsUnit("cm", 1e-2);
        ...
        public static fsUnit SquareCentiMeter = new fsUnit("cm2", 1e-4);
        ...
        public static fsUnit GrammePerCubicCentiMeter = new fsUnit("g/cm3", 1e-3 / 1e-6);
