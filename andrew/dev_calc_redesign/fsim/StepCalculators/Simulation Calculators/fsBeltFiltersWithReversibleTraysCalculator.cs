...
{
    public class fsBeltFiltersWithReversibleTraysCalculator : fsCalculatorEquationsList
    {
        public override void AddToCalculator(fsCalculator calculator)
        {
            ...
            calculator.AddEquation(new fsTechnicalTimeFrom0Equation(ttech, ttech0, filterAreaAs, lambda));
            ...
            calculator.AddEquation(new fsTrSrTtechNsTcEquation(sr, tr, tc, ns, ttech));
            calculator.AddEquation(new fsTfSfTtechNsTcEquation(sf, filtrationTime, tc, ns, ttech));
            ...
            calculator.AddEquation(new fsHcQmsEquation(cakeHeigth, Qms, filterArea, rhoCd, hce0, ns, ttech, kappa, pc, pressureDifference, sf, etaf));
